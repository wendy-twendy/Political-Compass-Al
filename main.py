...
def submit_demographics():
    ...
    # Log demographic information (in real applications, consider storing in a database)
    logging.info(
        f"Demographics submitted: Age={age}, Sex={sex}, Country={country}")

    # You can add further processing here, such as storing the information in the session
    session['demographics'] = {'age': age, 'sex': sex, 'country': country}
